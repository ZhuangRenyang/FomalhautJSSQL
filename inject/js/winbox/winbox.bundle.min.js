...
(function () {
    ...
    };var x = [], y = {capture: !0, passive: !0}, z, da = 0, A = 10, J, K, L, fa, P, Q;
    ...
    function V(a, b) {
        ...
        if (I) this.hide(); else if (this.focus(), g || 0 === g) this.index = g, w(this.g, "z-index", g), g > A && (A = g);
        ia(this);
    ...
    f.fullscreen = function (a) {
        ...
        if (!J || !za()) this.body[L](), J = this, this.full = !0, this.onfullscreen && this.onfullscreen(); else if (!1 === a) return this.restore();
        return this
    };
