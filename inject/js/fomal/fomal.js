...
$.ajax({
  ...
  data: {
    key: 'SYSBZ-HW6WW-CY7RT-365VO-WDUR6-U5F4N',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(120.777099,31.465952, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Iridescent Trajectory🌠 %c 你正在访问Iridescent Trajectory🌠の小家",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/%E8%99%B9%E8%89%B2%E8%BD%A8%E8%BF%B9-9999FF?style=flat&logo=meteor' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/%E8%99%B9%E8%89%B2%E8%BD%A8%E8%BF%B9-9999FF?style=flat&logo=meteor' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.voooe.cn/images/2023/06/01/wallhaven-x6128o.jpg);
    --darkmode-bg:url(https://tuchuang.voooe.cn/images/2023/06/01/wallhaven-85kjp1.png);
    --mobileday-bg: url(https://tuchuang.voooe.cn/images/2023/06/01/wallhaven-vqgeg5.jpg);
    --mobilenight-bg: url(https://tuchuang.voooe.cn/images/2023/06/01/wallhaven-9my3w1.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<a class="swf" id="swf_MaoKenZhuYuanTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'MaoKenZhuYuanTi'!important;color:black" onclick="setFont('MaoKenZhuYuanTi')">猫啃珠圆</a>
<a class="swf" id="swf_ZiXiaoHunMiaoMiaoTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiXiaoHunMiaoMiaoTi'!important;color:black" onclick="setFont('ZiXiaoHunMiaoMiaoTi')">喵喵体</a>
<a class="swf" id="swf_ZiXiaoHunLingDongBuDingTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiXiaoHunLingDongBuDingTi'!important;color:black" onclick="setFont('ZiXiaoHunLingDongBuDingTi')">灵动布丁</a>
<a class="swf" id="swf_ZiXiaoHunYunMiTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiXiaoHunYunMiTi'!important;color:black" onclick="setFont('ZiXiaoHunYunMiTi')">玉米体</a>
<a class="swf" id="swf_ZiXiaoHunMengQuGuoDongTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiXiaoHunMengQuGuoDongTi'!important;color:black" onclick="setFont('ZiXiaoHunMengQuGuoDongTi')">萌趣果冻</a>
<a class="swf" id="swf_ZiHunBaiGeTianXingTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiHunBaiGeTianXingTi'!important;color:black" onclick="setFont('ZiHunBaiGeTianXingTi')">白鸽天行</a>
<a class="swf" id="swf_ZiHunHuaBanTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiHunHuaBanTi'!important;color:black" onclick="setFont('ZiHunHuaBanTi')">花瓣体</a>
<a class="swf" id="swf_ZiHunMengQuRuanTangTi" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiHunMengQuRuanTangTi'!important;color:black" onclick="setFont('ZiHunMengQuRuanTangTi')">萌趣软糖</a>
<a class="swf" id="swf_ZiHunZhenHunShouShu" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZiHunZhenHunShouShu'!important;color:black" onclick="setFont('ZiHunZhenHunShouShu')">镇魂手书</a>
